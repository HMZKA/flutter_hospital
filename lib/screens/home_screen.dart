...
import '/screens/appointment/notification_screen.dart';
          ...
          children: [
            ...
            BlocBuilder<AppCubit, AppState>(builder: (context, state) {
              return state is GetDoctorsLoadingState
                  ...
                  : AppCubit().get(context).doctorsList != null
                      ? Expanded(
                                ...
                                .map(
                                  (e) => Card(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Image.network(
                                          "${AppCubit().get(context).doctorImages[e.doctorname]}",
                      ...
                      : const Text("Something Wrong Happend");
            })
          ],
        ),
      ),
